...
- Runtime discovery and JSON evidence for links, buttons, inputs, selects, textareas, summaries, and explicit ARIA roles across 78 desktop/mobile route-persona inventories: 5,497 visible instances and 514 distinct signatures in the latest serialized run.
