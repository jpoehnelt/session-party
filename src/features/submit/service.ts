      ...
      db.insert(speakers).select(
        db
          .select({
            ...
            headshotUrl: sql<string | null>`null`.as("headshot_url"),
            links: sql<unknown>`null`.as("links"),
            visible: sql<boolean>`1`.as("visible"),
            profileSourceId: sql<string | null>`null`.as("profile_source_id"),
            profileSourceVersion: sql<number | null>`null`.as("profile_source_version"),
            profileReviewStatus: sql<"draft">`'draft'`.as("profile_review_status"),
            profileReviewNote: sql<string | null>`null`.as("profile_review_note"),
            profileSubmittedAt: sql<Date | null>`null`.as("profile_submitted_at"),
            profileReviewedAt: sql<Date | null>`null`.as("profile_reviewed_at"),
            profileReviewedBy: sql<string | null>`null`.as("profile_reviewed_by"),
            version: sql<number>`1`.as("version"),
            createdAt: sql<Date>`${nowMs}`.as("created_at"),
            updatedAt: sql<Date>`${nowMs}`.as("updated_at"),
          })
