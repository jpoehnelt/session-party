...
export const operations = [
  ...
  {
    id: "events.previewTeamCopy", kind: "query", input: PreviewTeamCopyInput, output: TeamCopyPreview,
    authorize: memberManagementAuthorization, invoke: previewTeamCopy,
    rest: { method: "get", path: "/events/:eventId/team-copy/preview", input: { path: ["eventId"], query: ["sourceEventId"] }, summary: "Preview exact event memberships to copy", successStatus: 200 },
    idempotency: "none", concurrency: "none", emits: [],
  } satisfies AnyOperationDef,
  {
    id: "events.applyTeamCopy", kind: "command", input: ApplyTeamCopyInput, output: ApplyTeamCopyOutput,
    authorize: memberManagementAuthorization, invoke: applyTeamCopy,
    rest: { method: "post", path: "/events/:eventId/team-copy", input: { path: ["eventId"], body: ["sourceEventId", "idempotencyKey"] }, summary: "Copy missing team memberships from another event", successStatus: 200 },
    idempotency: "required", concurrency: "none", emits: ["events.member.added"],
  } satisfies AnyOperationDef,
  {
