...
export const operations = [
  ...
  {
    id: "events.previewClone", kind: "query", input: PreviewEventCloneInput, output: EventClonePreview,
    authorize: memberManagementAuthorization, invoke: previewEventClone,
    rest: { method: "post", path: "/events/:eventId/clone/preview", input: { path: ["eventId"], body: ["name", "slug", "startsAt", "endsAt", "includeTeam"] }, summary: "Preview a private structure-only event clone", successStatus: 200 },
    idempotency: "none", concurrency: "none", emits: [],
  } satisfies AnyOperationDef,
  {
    id: "events.clone", kind: "command", input: ApplyEventCloneInput, output: ApplyEventCloneOutput,
    authorize: memberManagementAuthorization, invoke: applyEventClone,
    rest: { method: "post", path: "/events/:eventId/clone", input: { path: ["eventId"], body: ["name", "slug", "startsAt", "endsAt", "includeTeam", "expectedSourceVersion", "expectedStructureFingerprint", "idempotencyKey"] }, summary: "Create an unpublished event from source structure", successStatus: 201 },
    idempotency: "required", concurrency: "required", emits: ["events.cloned", "events.member.added"],
  } satisfies AnyOperationDef,
  {
