...
export const operations = [] as const satisfies readonly AnyOperationDef[];

export const operationById = Object.fromEntries(
  operations.map((operation) => [operation.id, operation]),
) as Readonly<Record<string, AnyOperationDef>>;

export const restRegistrations = [] as const satisfies readonly RestRegistrationDescriptor[];

export const mcpTools = [] as const satisfies readonly McpToolDescriptor[];

export const partyIntents = [] as const satisfies readonly PartyIntentDescriptor[];
