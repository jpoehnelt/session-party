/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 50bcf6198f1bceeea9b17142c1f8abee)
...
interface __BaseEnv_Env {
	...
	TURNSTILE_SITE_KEY: "preview-fake" | "0x4AAAAAAELTRHiRum336lV9";
	TURNSTILE_HOSTNAMES: "invalid" | "sessionparty.com";
	EVENT_ROOM: DurableObjectNamespace<import("./src/server/index").EventRoom>;
	SCHEDULER: DurableObjectNamespace<import("./src/server/index").Scheduler>;
	AIRTABLE_SYNC: DurableObjectNamespace<import("./src/server/index").AirtableSyncLane>;
	AIRTABLE_RATE_LIMITER: DurableObjectNamespace<import("./src/server/index").AirtableRateLimiter>;
	MCP_OBJECT: DurableObjectNamespace<import("./src/server/index").SessionPartyMcp>;
	EMAIL?: SendEmail;
	AI?: Ai;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "EventRoom" | "Scheduler" | "SessionPartyMcp" | "AirtableSyncLane" | "AirtableRateLimiter";
	}
	interface PreviewEnv {
		...
		TURNSTILE_SITE_KEY: "preview-fake";
		TURNSTILE_HOSTNAMES: "invalid";
		EVENT_ROOM: DurableObjectNamespace<import("./src/server/index").EventRoom>;
		SCHEDULER: DurableObjectNamespace<import("./src/server/index").Scheduler>;
		AIRTABLE_SYNC: DurableObjectNamespace<import("./src/server/index").AirtableSyncLane>;
		AIRTABLE_RATE_LIMITER: DurableObjectNamespace<import("./src/server/index").AirtableRateLimiter>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PREVIEW_MODE" | "APP_URL" | "INITIAL_ADMIN_EMAIL" | "MAIL_FROM" | "TURNSTILE_SITE_KEY" | "TURNSTILE_HOSTNAMES" | "SESSION_SECRET" | "TURNSTILE_SECRET">> {}
}
